; ModuleID = 'account_bad.c'
source_filename = "account_bad.c"
...
@.str.1 = private unnamed_addr constant [14 x i8] c"account_bad.c\00", align 1
...
19:                                               ; preds = %10
  call void @__assert_fail(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i64 0, i64 0), i32 30, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__PRETTY_FUNCTION__.check_result, i64 0, i64 0)) #4
  unreachable

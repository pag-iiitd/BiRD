; ModuleID = 'bigshot_s2.c'
source_filename = "bigshot_s2.c"
...
@.str.1 = private unnamed_addr constant [12 x i8] c"v[0] == 'B'\00", align 1
@.str.2 = private unnamed_addr constant [13 x i8] c"bigshot_s2.c\00", align 1
...
16:                                               ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i64 0, i64 0), i32 45, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #5
  unreachable
